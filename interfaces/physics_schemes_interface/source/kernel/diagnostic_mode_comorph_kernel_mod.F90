...
!-----------------------------------------------------------------------------
!> @brief Clone of usual comorph kernel for use with diagnostic_mode_comorph_alg_mod
!>
module diagnostic_mode_comorph_kernel_mod
  ...
  !>
  type, public, extends(kernel_type) :: diagnostic_mode_comorph_kernel_type
    private
  ...
  contains
    procedure, nopass :: diagnostic_mode_comorph_code
  end type

  public :: diagnostic_mode_comorph_code
...
contains
  ...
  subroutine diagnostic_mode_comorph_code(nlayers, seg_len,             &
                          outer,                             &
                          rho_in_w3,                         &
                          rho_in_wth,                        &
                          wetrho_in_w3,                      &
...
!$  use omp_lib, only : omp_get_max_threads
    ...
    ! Do nothing and return to caller for now
    return
...
!$  segments = omp_get_max_threads()
  ...
  end subroutine diagnostic_mode_comorph_code

end module diagnostic_mode_comorph_kernel_mod
